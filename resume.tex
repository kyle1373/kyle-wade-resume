...
\begin{center}
    ...
    \begin{minipage}[b]{0.24\textwidth}
            ...
            {\href{https://www.linkedin.com/in/kylewade1373/}{LinkedIn} } \\
            \href{https://github.com/kyle1373}{GitHub}
    \end{minipage} 
    \vspace{-0.45cm} 
\end{center}
...
\subtext{IEEE - Eta Kappa Nu (HKN) / {\normalsize\normalfont \href{https://hkn.ucsd.edu}{Website}} \hfill La Jolla, CA} 
    \begin{zitemize}
...
\subtext{IEEE - Eta Kappa Nu (HKN) /  {\normalsize\normalfont \href{https://github.com/HKN-UCSD/}{Github}} \hfill La Jolla, CA} 
    \begin{zitemize}
        \item Improve and maintain organization-specific programs and websites, such as a member portal where HKN members can \textbf{sign in to HKN-specific events}, \textbf{log participation in HKN-specific events}, and \textbf{store their technical resumes}.
...
%%%%%%% ----------------------------------- Role 1 ----------------------------------- %%%%%%%
\subsection*{Hobbies Inc.: Online Hobby Forum - {\normalsize\normalfont \href{https://hobbies-inc.netlify.app/}{Website} / \href{https://github.com/acmucsd-projects/wi21-dolphin}{GitHub}} \hfill} 
    \begin{zitemize}
