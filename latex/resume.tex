...
%%%%%%% ----------------------------------- Role 4 ----------------------------------- %%%%%%%
\subsection*{Software Engineer Intern \hfill June 2022 --- Present} 
\vspace{-.05cm}
\subtext{Qualcomm\hfill San Diego, CA} 

    \begin{zitemize}
        \item Impacting \textbf{millions of people} through solving embedded, real-time operating system-level issues relating to \textbf{5G technology} using C, C++, and Python.
